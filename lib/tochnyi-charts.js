...
const Tochnyi = {
    ...
    // Core brand palette. Use this for semantic/focus treatments where brand
    // identity matters more than categorical separation.
    palette: [0x005bbb, 0xffd500, 0x0088ff, 0xcc9900, 0x003d7a, 0xffeb3b],

    // Qualitative categorical palette. Adjacent colors deliberately move
    // across hue families instead of walking through blue/yellow variants.
    categoricalPalette: [
        0x005bbb, 0xffd500, 0xd95f59, 0x2e9d65, 0x8a63d2,
        0x2a9d9f, 0xe07a3f, 0xc85d9e, 0x7a8f3d, 0x3f8fc5,
        0x9b6a42, 0x6c78c8, 0x59a88f, 0xc55a4a, 0x607d86
    ],
    ...
    createPieSeries: function(root, chart, options) {
        ...
        series.get("colors").set("colors",
            (options.colors || this.categoricalPalette).map(c => am5.color(c))
        );
    ...
    applyBarColors: function(series, colors) {
        var palette = colors || this.categoricalPalette;
        var self = this;
