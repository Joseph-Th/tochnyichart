    ...
    function trendLabelLayout(data, options) {
        ...
        ordered.forEach(function(entry) {
            ...
            candidates.some(function(placement) {
                var candidate = labelCandidate(points[index], size, placement, gap);
                ...
                if (segments.some(function(segment) { return segmentHitsRect(segment[0], segment[1], box, lineTolerance); })) return false;
                selected = candidate;
                return true;
            });
