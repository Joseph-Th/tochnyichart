(function(root, factory) {
    ...
    function schedule() {
        ...
        function chartReady() {
            ...
            var regionalStage = document.querySelector('.tochnyi-map-stage[data-map-workflow="regional-breakdown"]');
            if (regionalStage && regionalStage.getAttribute('data-map-layout-stable') !== 'true') return false;
