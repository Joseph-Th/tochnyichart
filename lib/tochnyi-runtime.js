    ...
    function renderBenchmarkGap(spec, chartNode) {
        ...
        data.forEach(function(item, index) {
            ...
            var labelPlan = global.TochnyiVisualPlan && global.TochnyiVisualPlan.benchmarkGapLabelPlan
                ...
                : [
                    { x: actualX, lane: 0, textAnchor: 'middle' },
                    { x: gapCenterX, lane: 1, textAnchor: 'middle' },
                    { x: benchmarkX, lane: 0, textAnchor: 'middle' }
                ];
            var labelBaseY = y + 38;
            ...
            svg.appendChild(svgElement('text', {
                x: labelPlan[0].x, y: labelBaseY + labelPlan[0].lane * labelLaneHeight,
            ...
            svg.appendChild(svgElement('text', {
                x: labelPlan[2].x, y: labelBaseY + labelPlan[2].lane * labelLaneHeight,
            ...
            svg.appendChild(svgElement('text', {
                x: labelPlan[1].x, y: labelBaseY + labelPlan[1].lane * labelLaneHeight,
                'text-anchor': labelPlan[1].textAnchor,
                class: 'tochnyi-svg-gap-label', fill: gapColor,
