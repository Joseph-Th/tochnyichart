(function(global) {
    ...
    function render(spec, chartNode) {
        ...
        function layout() {
            ...
            pack(sides.left, topLeft, bottom, gap, usePortRouting ? 'optimized' : 'source');
            pack(sides.right, topRight, bottom, gap, usePortRouting ? 'optimized' : 'source');
            ...
            // Default leader geometry is deliberately single-pass. We measure
            // the resulting lines for QA, but diagnostics do not steer the
            // route. This keeps the visual arrangement predictable and avoids
            // turning regional annotation into a crossing-optimization problem.
