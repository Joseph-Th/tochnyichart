            ...
            if (routedEntries.routing === 'ports') {
                ...
                function planPortRoutes() {
                    ...
                    var routeSettings = {
                        ...
                        // Region fills are evidence, not physical barriers. Leaders may cross
                        // geography; only collisions with other leaders should trigger a detour.
                        obstacles: [],
                        sourceObstacles: [],
                ...
                chartNode.setAttribute('data-map-port-obstacle-avoidance', 'leader-lines-only');
