(function(global) {
    ...
    function render(spec, chartNode) {
        ...
        function layout() {
            ...
            var bottom = height - regionalPolicy.stageInset - matrixFooterInset;
            ...
            if (routedEntries.routing === 'ports') {
                ...
                function planPortRoutes() {
                    ...
                    var sourceRegionIds = itemRegionIds(entry.item);
                    var sourceRouteObstacles = activeObstacles.filter(function(obstacle) {
                        return sourceRegionIds.indexOf(obstacle.regionId) !== -1;
                    });
                    var routeObstacles = activeObstacles.filter(function(obstacle) {
                        return sourceRegionIds.indexOf(obstacle.regionId) === -1;
                    });
                    var routeSettings = {
                        mapEdgeX: mapEdgeX,
                        ...
                        // A leader may leave its own highlighted region, but it must not run
                        // through another highlighted region. Leader-to-leader clearance is
                        // handled by the same route planner.
                        obstacles: routeObstacles,
                        sourceObstacles: sourceRouteObstacles,
                ...
                chartNode.setAttribute(
                    ...
                    'highlighted-regions-and-leader-lines'
                );
