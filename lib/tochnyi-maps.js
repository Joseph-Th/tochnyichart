(function(root, factory) {
    ...
    var regionalBreakdownPolicy = Object.freeze({
        // Six or more callouts benefit from the bounded port spline even when
        // the map is not dense. Direct lane fan-out remains available for very
        // small maps, while medium and dense sets share one predictable curve
        // model instead of changing visual grammar at eight items.
        portRoutingThreshold: 6,
        denseThreshold: 9,
        cardInset: 10,
        cardWidthDense: 190,
    ...
    function buildOrthogonalLeaderPath(entry, geometry) {
        ...
        // Keep the lane geometry as a set of monotonic waypoints for
        // separation, then let the shared spline builder calculate one tangent
        // at each join. Hand-authored cubic sections used independent tangents
        // at the fan and bend points, which could reverse direction and create
        // a visible S-kink when the card was far above or below the region.
        var smooth;
