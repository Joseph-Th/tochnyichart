(function(root, factory) {
    ...
    function resolveMapPlan(map, regionSet, data, featureById) {
        ...
        var alignedBounds = viewportMode === 'data'
            ? balanceViewportCenter(paddedBounds, rawBounds, contextBounds, configuration.viewportAlignment || 'auto')
            : null;
        return {
            activeRegionIds: activeIds,
            excludedRegionIds: exclusions,
            viewportMode: viewportMode,
            viewportAlignment: alignedBounds && alignedBounds.alignment || 'data',
